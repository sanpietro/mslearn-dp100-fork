...
def create_aml_workspace():
    ...
    run_cli_command(f"az ml data create --name diabetes-folder --path ./data")
    run_cli_command("az ml component create --file ./fix-missing-data.yml")
    run_cli_command("az ml component create --file ./normalize-data.yml")
    run_cli_command("az ml component create --file ./train-decision-tree.yml")
    run_cli_command("az ml component create --file ./train-logistic-regression.yml")
